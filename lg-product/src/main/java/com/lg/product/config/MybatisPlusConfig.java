...
public class MybatisPlusConfig {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\workSpace-1711f/lg-parent/lg-parent/lg-product/src/main/java");
        gc.setAuthor("wangxianhui");
        gc.setOpen(false);
        mpg.setGlobalConfig(gc);

        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://localhost:3306/shop?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return "D:\\workSpace-1711f/lg-parent/lg-parent/lg-product/src/main/resources/mappers/" /*+ pc.getModuleName()
